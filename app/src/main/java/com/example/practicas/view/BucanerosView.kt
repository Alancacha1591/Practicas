...
@Composable
fun BucanerosView(navController: NavController){
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                ...
                title = {
                    Image(
                        painter = painterResource(id = R.drawable.topbucaneros),
                        contentDescription = "Bills Logo",
                        modifier = Modifier.height(50.dp)
                    )
                },
                colors = TopAppBarDefaults.centerAlignedTopAppBarColors(
                    containerColor = Color(0xFF422622)
                )
            )
        },
    ){ paddingValues ->
        ...
        Box(
            ...
            Image(
                ...
                painter = painterResource(id = R.drawable.bakerback),
            ...
            ContentBucanerosView(paddingValues)
        }
    }
}

@Composable
fun ContentBucanerosView(paddingValues: PaddingValues){
    ...
    Column(
        ...
        Space(20)
        Text(
            text = "Son un equipo profesional de fútbol americano de los Estados Unidos con sede en Tampa, Florida. Compiten en la División Sur de la Conferencia Nacional (NFC) de la National Football League (NFL)",
...
fun HeaderBucaneros() {
    Row(
        ...
        // Logo (Lado Izquierdo)
        Image(
            painter = painterResource(id = R.drawable.bucaneros),
        ...
        Column(modifier = Modifier.weight(0.6f).padding(start = 8.dp)) {
            Text(text = "Tampa Bay Bucaneers", fontSize = 25.sp, fontWeight = FontWeight.ExtraBold)
            Text(text = "1976-presente", fontSize = 20.sp, color = Color.Gray)
        }
    }
}

@Composable
fun ChampionshipsBucaneros() {
    Row(
        modifier = Modifier.fillMaxWidth(),
        ...
        Column(horizontalAlignment = Alignment.CenterHorizontally) {
            ...
            Text(text = "(2002 (XXXVII), 2020 (LV))", fontSize = 15.sp)
        }
    }
}

@Composable
fun LeadersBucaneros() {
    Row(
        ...
        Column(
            ...
            // Datos del Jugador
            Text(text = "Baker Mayfield", fontWeight = FontWeight.Bold, textAlign = TextAlign.Center)
            Text(text = "#06 QB", fontSize = 16.sp, textAlign = TextAlign.Center)
        }
        ...
        Column(
            ...
            Image(
                ...
                painter = painterResource(id = R.drawable.hdbucaneers),
            ...
            Text(text = "Todd Bowles", fontWeight = FontWeight.Bold, textAlign = TextAlign.Center)
            Text(text = "(2022–present)", fontSize = 16.sp, textAlign = TextAlign.Center)
        }
    }
}
...
@Composable
fun BucanerosHelmet() {
    Image(painter = painterResource(id = R.drawable.helmetbucaneers), contentDescription = "Casco Ravens", modifier = Modifier.height(150.dp))
}

@Composable
fun BucanerosUniforms() {
    Row(
        modifier = Modifier.fillMaxWidth(),
        horizontalArrangement = Arrangement.SpaceEvenly
    ) {
        ...
        Image(painter = painterResource(id = R.drawable.uniformbucaneers), contentDescription = "Uniforme Color", modifier = Modifier.height(250.dp))
    }
}

@Composable
fun StadiumBucaneros() {
    // Usar una Card o un Box para el fondo de la imagen del estadio si quieres un borde
    Column(horizontalAlignment = Alignment.CenterHorizontally) {
        Image(painter = painterResource(id = R.drawable.stadiumbucaneers), contentDescription = "M&T Bank Stadium", modifier = Modifier.height(150.dp))
        Space(10)
        Text(text = "Raymond James Stadium", fontWeight = FontWeight.ExtraBold)
        Text(text = "Capacidad 65,618")
        Text(text = "Coste \$168 500 000 USD")
    }
}